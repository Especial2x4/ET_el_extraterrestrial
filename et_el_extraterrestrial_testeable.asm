...
.checkCollisionObjectNotInWell
   ...
   ; --- LÍNEA PARA DEBUGUEAR ---
   ;jmp .setHumanToReturnHome       ; Salto explícito a la rutina de salida [5]
   ; ----------------------
...
.checkForScientistCollision
   ...
   ;jmp .setHumanToReturnHome         ; Salto directo para que el científico se retire para debuguear
...
CheckForETCollectingCandy
   ...
   sta heldCandyPieces
   ;------ bloque agregado para recuperar energia al comer un candy ---------------
   ldx #$03                         ; Carga el valor de cientos (3) [3]
   ldy #$60                         ; Carga el valor de decenas y unidades (60) [3]
   jsr IncrementETEnergy            ; Llama a la función que suma la energía [2]
   ;-------------------------------------------------------------------------------
   lda #PLAY_SOUND_CHANNEL0 | $1C
   sta soundDataChannel0
...
;--------------------------------------
   ...
   bcc .waitLoop              ; 2≥
   ;lda #LT_RED+4              ; 2
   lda #BLACK                 ; asigna el color para las letras del titulo
   sta COLUP0                 ; 3 = @11
   sta COLUP1                 ; 3 = @14
...
;--------------------------------------
   ;lda #LT_BROWN+10           ; 2
   lda #BLACK                 ; cambia el color del alien del title screen
   sta COLUP0                 ; 3 = @05
   sta COLUP1                 ; 3 = @08
   lda #H_ET_GRAPH-1          ; 2
   sta loopCount              ; 3
...
TitleETGraphics_0
   ...
   ;.byte %01110000
   ;.byte %10111000
   .byte $00;%11011100; |XX.X....| final es la parte de abajo del alien
   .byte $00;%01101110 ; |........|
   .byte %10000000;$00;%01111100 ; |XX.X....|
   .byte %11000000;$00 ; |XXX.....|
   .byte %11000000;$00;%10000000 ; |...X....|
   .byte %11100000;$00;%10000000 ; |XXX.....|
   .byte %01110000;$00;%10000000 ; |.X.X....|
   .byte %10111000;$00;%10000000 ; |XXXX....|
   .byte %11011100;$00;%11000000 ; |.X......|
   .byte %01101111;$00;%11000000 ; |XXXX....|
   .byte %01111101;$00;%11100000 ; |X.X.....|
   .byte $00;%01100000 ; |XX.X....|
   .byte %10000000;%10110000 ; |X.X.X...|
   .byte %10000000;$00;%11011000 ; |XXXX.X..|
   .byte %10000000;%01101100 ; |XX..X...|
   .byte %10000000;$00;%01111000 ; |XXXX....|
   .byte %11000000;$00;%00110000 ; |X.X.X...|
   .byte %11000000;$00 ; |XX.X.X..|
   .byte %11100000;$00 ; |XXX.XX..|
   .byte %01110000;$00;%11000000 ; |XX.XX...|
   .byte %10110000;$00;%11000000 ; |.XXX.X..|
   .byte %11011000;$00;%11100000 ; |XXXXX...|
   .byte %01101100;$00;%11100000 ; |X.XX.X..|
   .byte %00111100;$00;%11100000 ; |XXXXX...|
   .byte %00110000;$00;%11100000 ; |XXXX.X..|
   .byte $00;%11100000 ; |.X.XX...|
   .byte $00;%11100000 ; |XXXXX...|
   .byte %11000000;$00;%11100000 ; |XX.XX...|
   .byte %11000000;$00;%11000000 ; |XX.X....|
   .byte %11100000;11111111;%10000000 ; |XX.X....| de aca para abajo está mas o menos bien (cabeza del alien)
   .byte %11100000;%11111111;$00 ; |X.X.....|
   .byte %11100000;%11111111;$00 ; |.X......|
   .byte %11100000;%11111111;$00 ; |X.......| principio
TitleETGraphics_1
   .byte $00 ; |........|punta de la cabeza del alien
   .byte $00;%11100000;$00 ; |........|
   .byte $00;%11111111;$00 ; |........|
   .byte $00;%11111111;%00000011 ; |........|punta de la cabeza
   .byte %00000111 ; |........|pedazos que sobran
   .byte %00000110 ; |........|
   .byte %00001000 ; |........|
   .byte %00001000 ; |........|esto es la pera del alien
   .byte %00000111 ; |........|
   .byte %00000010 ; |........|
   .byte %00001010 ; |........|
   .byte %00001111 ; |........|
...
TitleETGraphics_2
   ...
   .byte %10101011 ; |...XXXXX|
   .byte %01001011 ; |....XXXX|
   .byte %10111111 ; |..X.XXXX|
   .byte %11010111 ; |...XXXXX|
   .byte %11011011 ; |..XX.XXX|
   .byte %11101101 ; |..XXXXXX|
   .byte %11110110 ; |XX.XX.XX|
   .byte %11110110 ; |.XXXXXXX|
   .byte %10110111 ; |XX.XXX.X|
   .byte %01110001 ; |.XX.XXXX|
   .byte %01100101 ; |X.XX.X.X|
   .byte %01101110 ; |...XX.XX|
   .byte %01101111 ; |...XXX.X|
   .byte %00101111 ; |...X.XXX|
   .byte %00111011 ; |..XXX.X.|
   .byte %10111101 ; |...XXX.X|
   .byte %11011111 ; |...XX.X.|
   .byte %11011111 ; |X.XX.X.X|
   .byte %00111111 ; |.X.XXXX.|
   .byte $FF ; |XXXX.X.X|
   .byte %01111111 ; |.XX.X.XX|
   .byte %00111111 ; |X.X..XXX|
   .byte %00011111 ; |.X.XXXXX|
   .byte %00001111 ; |X.XXXXXX|
   .byte %00000111 ; |XXXXXXXX|
   .byte %00000011 ; |XXXXXXXX|
   .byte $00 ; |XXXXXXXX|
   .byte $00 ; |XXXXXXX.|
   .byte $00 ; |.XXXX.XX|
TitleETGraphics_3
   .byte $FF ; |........|
   .byte $FF ; |........|
   .byte %11100110 ; |.XXXXXXX|
   .byte %01011111 ; |XX......|
   .byte %10111111 ; |X.X.X.X.|
   .byte %11100110 ; |.XXXXXXX|
   .byte %11011111 ; |XXXXXXXX|
   .byte %10111111 ; |XXX.XXXX|
   .byte $FF ; |........|
   .byte %11111010 ; |XXXXXXXX|
   .byte %11110110 ; |XXXXXXXX|
   .byte %11111110 ; |XXXXXXXX|
   .byte %10001111 ; |XX.XXXXX|
   .byte %01111011 ; |XXXXXXXX|
   .byte %10000111 ; |XXXXXXXX|
   .byte %11111101 ; |XX.XXXXX|
   .byte %11111001 ; |XXXXXXXX|
   .byte %11110011 ; |XXXXXXXX|
   .byte %01111110 ; |XX.XXXXX|
   .byte %01011111 ; |XXXXXXXX|
   .byte %10001111 ; |XXXXXXXX|
   .byte %00101111 ; |XXXXXX.X|
   .byte %11010101 ; |..X..XXX|
   .byte %11101000 ; |..X..X.X|
   .byte %11110010 ; |XXXXXXX.|
   .byte %11111101 ; |XXXXX.XX|
...
TitleETGraphics_4
   ...
   .byte %01110111 ; |..XX....|
   .byte %10110111 ; |X..XX...|
   .byte %11101111 ; |X..XXXX.|
   .byte %11011111 ; |....XXXX|
   .byte %11111110 ; |XXX..XXX|
   .byte %11111000 ; |XXXX.XXX|
   .byte %11000000 ; |XXXXXXXX|
   .byte %01100001 ; |XXXXXXXX|
   .byte %01111111 ; |XXX.XX.X|
   .byte %10111110 ; |XXXXX.X.|
   .byte %11011101 ; |XXXX.XXX|
   .byte %11100011 ; |XXX.XXXX|
   .byte $FF ; |X.XXXXXX|
   .byte %11101101 ; |XXXXXX.X|
   .byte %01100100 ; |.X.XX.X.|
   .byte %10110111 ; |XXXXXXXX|
   .byte %11010011 ; |XX.X.X.X|
   .byte %11111001 ; |X.X...X.|
   .byte %11111100 ; |.XX...XX|
   .byte %10111111 ; |XXX...XX|
   .byte %00101111 ; |.XX..XXX|
   .byte %11001011 ; |XXX...XX|
   .byte %11111110 ; |X.X...X.|
   .byte %11111000 ; |XX.X.X.X|
   .byte $FF ; |.XXXXXXX|
   .byte $FF ; |XX.X.X.X|
   .byte $FF ; |X.X.X.X.|
   .byte $FF ; |XXXXX.XX|
   ...
   .byte $FF ; |XXXXXXXX|
   .byte $00 ; |XXXXXXXX|
   .byte %11110000 ; |XXXXXXXX|
   .byte %10000000 ; |XXXXXXXX|
   .byte $FF ; |..X.X.X.|
TitleETGraphics_5
   .byte %11110100 ; |XXXXXXXX|
   .byte %01110110 ; |...X.X.X|
   .byte %11101111 ; |XXXXXXXX|
   .byte %11101111 ; |XXXXXXXX|
   .byte $FF ; |.X..X.X.|
   .byte %11111101 ; |X.XXXXXX|
   .byte %11110110 ; |.X.XXXXX|
   .byte %11011011 ; |..X.XX.X|
   .byte %11011101 ; |.X.X.XXX|
   .byte %11011110 ; |X.XXX.XX|
   .byte %10111111 ; |XX.XXX.X|
   .byte %10111111 ; |XXX.XXX.|
   .byte $FF ; |XXXXX.XX|
   .byte %10110111 ; |XX.XXX.X|
   .byte %01011011 ; |XXX.XXX.|
   .byte %11011011 ; |XXXXXXXX|
   .byte %10001101 ; |.X.X.XXX|
   .byte %00000100 ; |XXXXXXXX|
   .byte %00000110 ; |X.XXXXXX|
   .byte %10000011 ; |XXX.X.XX|
   .byte %01000001 ; |X.XX.X.X|
   .byte %10100000 ; |XX.XXXXX|
   .byte %11100000 ; |XXX.X.X.|
   .byte $00 ; |XXXXXXXX|
   .byte %10000000 ; |.X.XX.X.|
   .byte %11111110 ; |XXXXXXXX|
   .byte %01110011 ; |.XX.XX.X|
   .byte %11111101 ; |XXXX.XXX|
   .byte %00011110 ; |X.XXXXX.|
   .byte $FF ; |.X.XXXXX|
   .byte $FF ; |X.XX.XX.|
   .byte $FF ; |.XXXXXX.|
   .byte $FF ; |XXXX.XX.|
...
ETWalkSprite_A0
   .byte $FF ;       |XXXXXXXX| $FE
   .byte $FF ;       |XXXXXXXX|
   .byte %11000010 ; |XX....X.| %11000010 $C3 
   .byte %00001110 ; |....XXX.| %00001110 $0F
   .byte %11111110 ; |XXXXXXX.| $FF
   .byte %00111110 ; |..XXXXX.| $3F
   .byte %00100010 ; |..X...X.| $2B
   .byte %11100110 ; |XXX..XX.| $E7
   .byte $00 ;       |........|
...
FlowerColors
   .byte GREEN+14,GREEN+14,GREEN+12,GREEN+10
   .byte GREEN+8,GREEN+6,GREEN+4
...
WashingtonPF2Graphics
   ...
   .byte $1F ; |...XXXXX|
   .byte $1F ; |...XXXXX|
   .byte $1F ; |...XXXXX|; desde acá
   .byte %00001111 ; |....XXXX|
   .byte %00001111 ; |....XXXX|
   .byte %00000101 ; |.....X.X|ventana
   .byte %00000101 ; |.....X.X|ventana
   .byte %00000101 ; |.....X.X|
   .byte %00000111 ; |.....XXX|
   .byte %00000111 ; |.....XXX|
...
ScientistColors_A
   .byte LT_BLUE+8,BLUE+6,RED_2+6,RED_2+6,BLUE,BLUE+2,BLUE+4
   .byte BLUE+4,BLUE+4,BLUE-4,BLUE+4,BLACK+2,BLACK,BLACK
ScientistColors_B
   .byte LT_BLUE+6,BLUE+4,RED_2+6,BLUE,BLUE+2,BLUE+4,BLUE+4
   .byte BLUE+4,BLUE+4,BLUE+4,BLACK+2,BLACK+2,BLACK,BLACK
...
FBIAgentSprites
FBIAgent_0
   .byte %00011100 ; |...XXX..| gorro sup
   .byte %00011110 ; |...XXXX.| vicera
   .byte %00011100 ; |...XXX..| vincha negra
   .byte $1C ; |...XXX..|
   .byte $7C ; |.XXXXX..| sacado de elliot
   .byte $D8 ; |XX.XX...|
   .byte $38 ; |..XXX...|
   .byte $38 ; |..XXX...|
   .byte $EC ; |XXX.XX..|
...
FBIAgentColors_A
   .byte BROWN+8,BROWN+8,BROWN,BROWN,BROWN+2,BROWN+2,BROWN+2
   .byte BROWN+2,BROWN,BROWN,BROWN,BROWN,BROWN+6,BLACK
FBIAgentColors_B
   .byte BROWN+8,BLACK,BROWN,BROWN+2,BROWN+2,BROWN+2,BROWN+2
   .byte BROWN+2,BROWN,BROWN,BROWN,BROWN+6,BLACK,BLACK
